...
app.post('/forward-request-condition', async (req, res) => {
    try {
        ...
        const apiUrl = 'https://api-satusehat-dev.dto.kemkes.go.id/fhir-r4/v1/Condition';
...
app.post('/forward-request-observation-nadi', async (req, res) => {
    try {
        ...
        const apiUrl = 'https://api-satusehat-dev.dto.kemkes.go.id/fhir-r4/v1/Observation';
